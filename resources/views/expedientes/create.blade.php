...
<div class="container-fluid">
    <div class="mb-4">
        <h2><i class="bi bi-file-medical-fill text-info me-2"></i>Nuevo Expediente Médico</h2>
                    ...
                    <form action="{{ route('expedientes.store') }}" method="POST">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('asistente_id') is-invalid @enderror" 
                                        ...
                                        @foreach($asistentes as $asistente)
                                            <option value="{{ $asistente->id }}" {{ old('asistente_id') == $asistente->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('diagnostico') is-invalid @enderror" 
                                              ...
                                              name="diagnostico" 
                                              rows="3"
                                              placeholder="Descripción del diagnóstico clínico">{{ old('diagnostico') }}</textarea>
                                    @error('diagnostico')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('descripcion_tratamiento') is-invalid @enderror" 
                                              ...
                                              rows="4"
                                              placeholder="Detalles del procedimiento realizado">{{ old('descripcion_tratamiento') }}</textarea>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('observaciones') is-invalid @enderror" 
                                              ...
                                              name="observaciones" 
                                              rows="3"
                                              placeholder="Notas adicionales, recomendaciones, etc.">{{ old('observaciones') }}</textarea>
                                    @error('observaciones')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-info">
                                <i class="bi bi-check-circle me-2"></i>Guardar Expediente
                            </button>
                        </div>
                    </form>
                </div>
